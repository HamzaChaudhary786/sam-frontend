...
import EmpSuggestions from "./EmpSuggestions"
        ...
        <div className="relative">
            ...
            <div className="relative">
                <input
                    ...
                    disabled={disabled}
                    className={`w-full px-3 py-2 border rounded-md text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 disabled:bg-gray-100 ${errors.length > 0 ? 'border-red-300' : 'border-gray-300'
                        }`}
                />
                ...
                {enableSuggestions && showSuggestions && inputValue.length >= minSearchLength && (
                    ...
                    >
                        {console.log(suggestions, "my all sugessions jajjajajajajajajaj")}
