...
const EmployeeGridTable = ({
  ...
  useEffect(() => {
    ...
    const handleTopScroll = () => {
      bottom.scrollLeft = top.scrollLeft; // Sync bottom with top
    };

    const handleBottomScroll = () => {
      top.scrollLeft = bottom.scrollLeft; // Sync top with bottom
    };
    ...
    <div>
      ...
      {loading ? (
        ...
        <div className="relative"
          ...
          onWheel={(e) => {
            if (e.deltaX !== 0 && bottomScrollRef.current && topScrollRef.current) {
              // Update both scrollbars on horizontal wheel scroll
              bottomScrollRef.current.scrollLeft += e.deltaX;
              topScrollRef.current.scrollLeft = bottomScrollRef.current.scrollLeft;
            }
          }}
          // Add keydown event listener for arrow key scrolling
          onKeyDown={(e) => {
            if (bottomScrollRef.current && topScrollRef.current) {
              if (e.key === "ArrowLeft") {
                bottomScrollRef.current.scrollLeft -= 50; // Adjust scroll amount as needed
                topScrollRef.current.scrollLeft = bottomScrollRef.current.scrollLeft;
          ...
          tabIndex={0} // Make the div focusable for key events
        >
          <div
            ref={topScrollRef}
            className="sticky top-0 z-50 bg-white overflow-x-auto scrollbar-thin scrollbar-thumb-gray-400 scrollbar-track-gray-200"
            style={{ height: "16px" }}
          ...
          < div
            ref={bottomScrollRef}
            className="overflow-x-auto scrollbar-thin scrollbar-thumb-gray-400 scrollbar-track-gray-200 rounded-t-xl"
          >
                  ...
                  return (
                    <>
                      ...
                      >
                        ...
                        <td
                          rowSpan={2}
                          className="x-4 py-2 border border-gray-200"
                        >
