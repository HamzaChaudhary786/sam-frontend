  ...
  const calculateRoundTotals = (assignment) => {
    ...
    assignment.roundHistory.forEach((entry) => {
      ...
      if (entry.shellCollected) {
        totalShell += parseInt(entry.shellCollected) || 0;
      }
    });
          ...
          <div className="space-y-6">
            ...
            <div className="bg-gray-50 rounded-lg p-4 space-y-3">
              ...
              <div className="grid grid-cols-4 gap-4 pt-3 border-t border-gray-200">
                ...
                <div className="text-center">
                  <p className="text-xs text-gray-500">Total Shell</p>
                  <p className="text-lg font-semibold text-red-600">
                    {collectedShells}
                  </p>
                </div>
              ...
              {assignment.roundHistory &&
                assignment.roundHistory.length > 0 && (
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-500"
                    placeholder={`Enter number of collected shells`}
                    required
                  />
                </div>
